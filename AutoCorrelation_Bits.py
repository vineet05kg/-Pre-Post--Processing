...
csvfile_location = (r'D:/Python/VacuumData_Analysis/ForAcquired_Date[18.Dec.2019]viaAPD/1MSas/Toeplitz1.csv') # For the location of CSV file//
csvfile_read = pd.read_csv(csvfile_location, index_col=[]) # To read the CSV file//
print("First 5 elements of all the columns of data file =", csvfile_read.head(10)) # To print the first ten elements of all the columns of CSV file//
